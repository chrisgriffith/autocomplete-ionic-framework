...
getTags = (callback) ->
  requestOptions =
    url: 'https://raw.githubusercontent.com/chrisgriffith/IonicBrackets/master/HtmlTags.json'
    json: true
...
getAttributes = (callback) ->
  requestOptions =
    url: 'https://raw.githubusercontent.com/chrisgriffith/IonicBrackets/master/HtmlAttributes.json'
    json: true
